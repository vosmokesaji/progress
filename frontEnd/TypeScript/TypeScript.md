[TypeScript 入门教程](https://ts.xcatliu.com/) 笔记
...
```bash
hello.ts:8:22 - error TS2345: Argument of type 'number[]' is not assignable to parameter of type 'string'.
```
...
其中 `0b1010` 和 `0o744` 是 [ES6 中的二进制和八进制表示法](http://www.nodeclass.com/api/ECMAScript6.html#number)，它们会被编译为十进制数字。
